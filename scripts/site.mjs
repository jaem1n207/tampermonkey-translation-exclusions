...
<div class="install-actions"><a class="button primary" href="${install}">${e(copy.hero.primary)} <span aria-hidden="true">↗</span></a><a class="secondary" href="${listingURL.replace('/en/', `/${copy.locale}/`)}?locale_override=1">${e(copy.hero.secondary)}</a></div>
